...
test: pixel.o PGMimageProcessor.o ConnectedComponent.o unit_tests.o
	g++ pixel.o ConnectedComponent.o PGMimageProcessor.o unit_tests.o -o tests.exe -std=c++2a
